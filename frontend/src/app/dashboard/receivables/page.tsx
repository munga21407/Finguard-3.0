  ...
  return (
    <div className="max-w-[1400px] mx-auto">
      ...
      <div className="flex justify-between items-end mb-8">
        ...
        <Link href="/dashboard/invoices/new" className="bg-lf-primary text-lf-on-primary px-6 py-3 rounded-lg text-sm font-bold shadow-sm hover:opacity-90 transition-all flex items-center gap-2">
